      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center my-8">
          <div className="lg:mr-12 flex flex-col lg:flex-row mb-8 lg:mb-0">
            <label htmlFor="search" className="text-2xl lg:mr-2 text-center">
              Search:
            </label>
            <input
              type="text"
              className="border-2 border-black py-1 px-2 text-xl"
              value={search}
          ...
          <div>
            <label htmlFor="size-slider" className="text-center block">
              Choose Size
            </label>
